...
\begin{frame}[t]
  ...
  \only<2>{
    ...
    \begin{columns}
      \begin{column}{.7\textwidth}
        \begin{alertblock}{ }
          Hard to get the time assignment right (not everybody will attend). Some suggestions to have the tutorials before rather than after the other workshop parts.
        \end{alertblock}
      \end{column}
    \end{columns}
  }
